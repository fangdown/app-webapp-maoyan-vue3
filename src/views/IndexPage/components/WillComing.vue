<template>
    <Swiper :slidesPerView="swiperOption.slidesPerView" :direction="swiperOption.direction"
        ...
        <Swiper-slide style="height: 5.9rem">
            <Slider :list="hotMovieScreenData.hotMovieData" type="willComing">近期最受期待</Slider>
        </Swiper-slide>
        <Swiper-slide v-for="(item, index) in hotMovieScreenData.hotMovieData" :key="index" style="height: 3.11rem">
            <div class="movieList">
